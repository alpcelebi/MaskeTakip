...
internal class Program
{
    ...
    {   //Değişkenler   
        ...
        SelamVer(isim: "Alp Eren");

        Vatandas vatandas1 = new Vatandas();
        int sonuc = Topla(3, 5);
        //Diziler / Arrays
        string[] ogrenciler = new string[3];
        ogrenciler[0] = "Alp Eren";
        ogrenciler[1] = "Yagız Alp";
        ogrenciler[2] = "Tugce ";
        ...
        string[] sehirler2 = new[] { "Yozgat", "Mersin", "Şanlıurfa" };
        sehirler2 = sehirler1;
        sehirler1[0] = "Adana";
        Console.WriteLine(sehirler2[0]);
        Person person1 = new Person();
        person1.FirstName = "Alp Eren";
        person1.LastName = "ÇELEBİ";
        person1.DateOfBirthYear = 1992;
        person1.NationalIdentity = 12312312312;
        Person person2 = new Person();
        person2.FirstName = "Yagız";
